<template>
	<div class="searchbar">
		<div class="container">
			<!-- 1.LOGO -->
			<!-- <img src="img/logo.png" alt="iWeb LOGO"> 无法显示-->
			<!-- 直接引用法使用图片 -->
			<img src="../assets/img/logo.png" alt="iWeb LOGO1">
			<!-- 数据绑定法使用图片 -->
			<img :src="logo" alt="iWeb LOGO2">
			<!-- 3.我的购物车 -->
...
<script>
	...
	export default{
		...
		data(){ 
			return{ 
				logo:require('../assets/img/logo.png') //模型变量
			}
		}
	}
